...
public class OkHttpClientManager {
     ...
     * @param object
     */
    private void _postAsyn(String url, final ResultCallback callback, String object) {
...
//        });
    ...
    public static void postAsyn(String url, final ResultCallback callback, String object) {
    ...
    private Request buildPostRequest(String url, String object) {
        RequestBody requestBody = RequestBody.create(MediaType.parse("application/json"),object);
        return new Request.Builder()
                .url(url)
                .post(requestBody)
                .build();
